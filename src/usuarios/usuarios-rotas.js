...
module.exports = app => {
  ...
  app
    ...
    .get(
      [middlewaresAutenticacao.bearer, middlewareAutorizacao('usuario', 'ler')],
  ...
  app
    .route('/usuario/:id')
    .delete(
      [middlewaresAutenticacao.bearer, middlewaresAutenticacao.local, middlewareAutorizacao('usuario', 'remover')],
